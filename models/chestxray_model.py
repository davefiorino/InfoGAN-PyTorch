...
class Generator(nn.Module):
    def __init__(self):
        super().__init__()
        # 168 x 1 x 1
        self.tconv1 = nn.ConvTranspose2d(168, 512, 4, bias=False)
        self.bn1 = nn.BatchNorm2d(512)
        # 512 x 4 x 4
        self.tconv2 = nn.ConvTranspose2d(512, 512, 4, 2, 1, bias=False)
        ...
        # 64 x 64 x 64
        self.tconv6 = nn.ConvTranspose2d(64, 1, 4, 2, 1, bias=False)
        # 1 x 128 x 128
